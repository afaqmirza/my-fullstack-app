    ...
    <div className="pdf-to-word-page">
      <section className="tool-header-hero">
        ...
        >
          ...
          <p>Convert your PDF files to editable Word documents (DOCX) directly from your browser.</p>
        </motion.div>
      </section>
        ...
        <AnimatePresence mode="wait">
          ...
          {status === 'success' && (
            ...
            >
              ...
              <p>Your Word document is ready for download.</p>

              <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                <a
                  href={downloadUrl}
                  download={`${file?.name.substring(0, file?.name.lastIndexOf('.')) || 'converted'}.docx`}
