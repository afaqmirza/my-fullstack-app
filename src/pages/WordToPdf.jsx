...
export default function WordToPdf() {
  ...
  const uploadAndConvert = async (fileToProcess) => {
    ...
    try {
      ...
      const response = await executeTool('word-to-pdf', formData);
      ...
      // Handle python error string disguised as 200 response sometimes
    ...
    <div className="word-to-pdf-page">
      <section className="tool-header-hero">
        ...
        >
          ...
          <p>Convert your DOC and DOCX files to PDF directly from your browser.</p>
        </motion.div>
      </section>
          ...
          {status === 'success' && (
            ...
            >
              ...
              <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                <a 
                  href={downloadUrl} 
                  download={`${file?.name.substring(0, file?.name.lastIndexOf('.')) || 'converted'}.pdf`}
